...
order=[2,1,0] #order of MZIs to multiply to get final unitary
positions=[0,1,0] #top waveguide each MZI is on
...
#Main diagonal
#MZI 1
A_res[0],B_res[0],C_res[0],theta0_res[0],V0_res[0],Vpi_res[0]=curvefit(0,0,2)
V_global[0]=V0_res[0]
#MZI 2
A_res[1],B_res[1],C_res[1],theta0_res[1],V0_res[1],Vpi_res[1]=curvefit(1,0,2)
V_global[1]=V0_res[1]

#First upper diagonal
V_global[0]=Vpi_res[0]
#MZI 3
A_res[2],B_res[2],C_res[2],theta0_res[2],V0_res[2],Vpi_res[2]=curvefit(2,0,1)
V_global[2]=V0_res[2]
