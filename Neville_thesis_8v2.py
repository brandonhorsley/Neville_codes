...
total_count = 50 #Total in each experiment
...
"""
#This code works
#Variant of: https://www.pymc.io/projects/docs/en/v3/pymc-examples/examples/mixture_models/dirichlet_mixture_of_multinomials.html
#Still not correct but this shows i am on the right track.
...
with pm.Model() as model_multinomial:
    ...
    counts = pm.Multinomial("counts", n=C, p=frac, shape=(N, M), observed=data)
