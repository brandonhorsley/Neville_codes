...
"""
Maps decently to fig 4.3a, much like previous code, it is like it is flipped in the 
antidiagonal but axes match and calculations line up more with me so i dunno.
